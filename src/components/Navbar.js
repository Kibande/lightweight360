    ...
    ">
      ...
      >
        <motion.a
          target={"_blank"}
          className="w-6 mr-3"
          href="https://www.instagram.com/liightweight360/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout our instgram profile"
        >
          <InstagramIcon />
        </motion.a>
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/company/lightweight360/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout our linkedin profile"
        >
          <LinkedInIcon />
        </motion.a>
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://x.com/Liightweight360"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout our Twitter profile"
        >
          <TwitterIcon />
        </motion.a>
      ...
      </div>
    {
      ...
      >
        <motion.a
          ...
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout my instgram profile"
        >
          <InstagramIcon />
        </motion.a>
        <motion.a
